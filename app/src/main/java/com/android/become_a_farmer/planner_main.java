...
public class planner_main extends Fragment {
    ...
    private ImageButton btn_start_planner;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_start_planner = (ImageButton) view.findViewById(R.id.btn_start_planner);

        btn_start_planner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), SelectRegion.class);
